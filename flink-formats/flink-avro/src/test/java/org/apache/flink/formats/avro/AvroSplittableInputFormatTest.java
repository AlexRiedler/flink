...
public class AvroSplittableInputFormatTest {
	...
	public void createFiles() throws IOException {
		...
		user1.setTypeTimestampMicros(Instant.parse("1970-01-01T00:00:00.123456Z"));
		// 20.00
		...
		User user2 = User.newBuilder()
				...
				.setTypeTimestampMicros(Instant.parse("1970-01-01T00:00:00.123456Z"))
				// 20.00
		...
		for (int i = 0; i < NUM_RECORDS - 2; i++) {
			...
			user.setTypeTimestampMicros(Instant.parse("1970-01-01T00:00:00.123456Z"));
			// 20.00
